...
export async function GET(req: NextRequest) {
  ...
  const r = await fetch(`${SB}/extrase?luna_id=eq.${lunaId}&select=id,valuta,iban,pdf_path,pdf_nume,nr_tranzactii,nr_documentate,sold_final&order=valuta`, { headers: H })
