      ...
      <main style={{ flex:1, padding:'44px 52px', maxWidth:'960px' }}>
        <div style={{ marginBottom:'32px' }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:'12px' }}>
            ...
            <h1 style={{ fontSize:'24px', fontWeight:700, color:'var(--c-ffffff)', letterSpacing:'-0.5px' }}>Furnizori & Entități</h1>
          </div>
          <p style={{ fontSize:'14px', fontWeight:500, color:'var(--c-888888)', marginTop:'6px', marginLeft:'22px' }}>
            Detectat automat din extrase bancare — toate lunile · {firma.nume}
          </p>
        </div>
