...
export default async function ModelDocumentePage({ params }: { params: Promise<{firma:string}> }) {
      ...
      <main style={{ flex:1, padding:'44px 52px', maxWidth:'820px' }}>
        <div style={{ marginBottom:'32px' }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:'12px' }}>
            ...
            <h1 style={{ fontSize:'24px', fontWeight:700, color:'#FFF', letterSpacing:'-0.5px' }}>Model documente</h1>
          </div>
